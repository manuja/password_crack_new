...
from utils import register_service_consul, get_ports, generate_unique_id, get_greater_than_nodes, get_node_election, announce_message, ready_for_get_node_election, get_node_details, check_health, generate_shedule,workloaddevide,read_password_file,broadcastFound,get_node_ports
...
async def handler(websocket, path):
        ...
        print('Generating the password combination in node 01')
